...
TOKEN_NUMS = 3000000
RATIO = 1.0
#EN_DATA_DIR = "/data/home/81054062/studyplace/competition/baichuan2fintune/competition_kit/data/process_data/f_en/data_en.jsonl"
#ZH_DATA_DIR = ""
#OUTPUT_FILES = "quant_class_1b_2_99_re.jsonl"
import sys
EN_DATA_DIR=sys.argv[1]
ZH_DATA_DIR=sys.argv[2]
...
def findAllFile(base):
    ...
    return files
enc = AutoTokenizer.from_pretrained(pretrained_model_name_or_path='/home/81054062/studyplace/competition/baichuan2fintune/competition_kit/data/models/falcon-rw-1b', use_fast=False, trust_remote_code=True)
